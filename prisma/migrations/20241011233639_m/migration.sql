...
CREATE TABLE "new_User" (
    ...
    CONSTRAINT "User_egresUniversityId_fkey" FOREIGN KEY ("egresUniversityId") REFERENCES "University" ("id") ON DELETE SET NULL ON UPDATE CASCADE,
...
INSERT INTO "new_User" ("addressId", "birthdate", "ci", "cmeg_n", "createAt", "createDate", "email", "exacAddress", "id", "isDelete", "lastname", "matricula", "name", "parentId", "password", "phoneCode", "phoneNumber", "rif", "role", "universityId", "updateAt") SELECT "addressId", "birthdate", "ci", "cmeg_n", "createAt", "createDate", "email", "exacAddress", "id", "isDelete", "lastname", "matricula", "name", "parentId", "password", "phoneCode", "phoneNumber", "rif", "role", "universityId", "updateAt" FROM "User";
DROP TABLE "User";
