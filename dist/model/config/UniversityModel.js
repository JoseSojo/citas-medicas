...
class UniversityModel extends AbstractModel_1.default {
    constructor() {
        super();
    }
    createUniversity(_a) {
    ...
    countUniversityBy(_a) {
        return __awaiter(this, arguments, void 0, function* ({ filter }) {
            const prisma = new client_1.PrismaClient();
            return yield prisma.university.count({ where: filter });
        });
    }
    findManyUniversity(_a) {
        return __awaiter(this, arguments, void 0, function* ({ filter, skip, take }) {
            const prisma = new client_1.PrismaClient();
            return yield prisma.university.findMany({
                where: filter,
    ...
    updateUniversity(_a) {
        return __awaiter(this, arguments, void 0, function* ({ data, filter }) {
            const prisma = new client_1.PrismaClient();
            return yield prisma.university.update({ data, where: filter });
        });
    }
    deleteUniversity(_a) {
        return __awaiter(this, arguments, void 0, function* ({ id }) {
            const prisma = new client_1.PrismaClient();
            return yield prisma.university.update({ where: { id }, data: { isDelete: true } });
        });
    }
}
